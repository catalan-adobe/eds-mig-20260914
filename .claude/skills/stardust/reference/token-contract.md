...
any downstream consumer (the stardust `deploy`/`rollout` skills for EDS, a framework component
...
- Downstream consumers (e.g., the stardust `deploy` skill) read the block from

/**
 * hero-teaser — WKND full-bleed hero teaser: 640px image with a white text panel
 * overlapping its bottom edge (≥1165px); stacked image + text below that.
 *
 * Schema: stardust/eds-schema/us-en-html.json → sections[6] "next-adventure"
 *   (heading + body + cta, 1 image). Variant `image-bottom` → object-position bottom.
 ...
 *
 * Authoring (one row): cell 1 <picture>; cell 2 <h2> title (or <h1> when the
 * teaser leads the page), description <p>, CTA <p><strong><a>…</a></strong></p>.
 * A link-free paragraph before the heading is the eyebrow (#51).
 */
